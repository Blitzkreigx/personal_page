...
export default function Home() {
  return (
    <main className="text-lg">
      <NavBar />
      <div className="w-full h-screen text-primary px-[75px] md:px-[100px]" id="acuell">
        <div className="fixed w-full h-full top-0 left-0 -z-50">
          ...
          ></video>
          <img src="/secondary-background.avif" alt="background" className="object-cover w-full h-full" />
          <div className="bg-opacity w-full h-full absolute top-0 left-0"></div>
        </div>
        <div className="flex flex-col justify-center items-start w-full h-full gap-[20px] md:max-w-[60%]">
      ...
      <div className="bg-primary px-[75px] md:px-[100px]" id="services">
        <div className="max-w-[400px] mx-auto py-[50px] md:max-w-full">
          ...
          <div className="flex flex-col justify-start items-start py-[30px] gap-[25px] md:flex-row">
          ...
          <div className="flex flex-col justify-start items-center gap-[25px] py-[25px] md:flex-row" id="a propos">
            <div className="w-full relative flex justify-end items-center">
              <img src="/professional.avif" alt="professional" className="w-full max-w-[350px] rounded-[30px] md:max-w-[80%]" />
              <div className="flex justify-center items-center gap-[15px] bg-buttons text-primary py-3 px-4 absolute bottom-[25px] left-0 right-[25px] md:left-[50px] max-w-[350px]">
                <div>
                  <p className="text-2xl md:text-3xl"><b>+20</b></p>
                  <p className="md:text-lg">Projects soutenus</p>
                </div>
                <div>
                  <p className="text-2xl md:text-3xl"><b>5</b></p>
                  <p className="md:text-lg">Ans d'experience</p>
                </div>
              </div>
            </div>
            <div className="flex flex-col justify-start items-start gap-[15px] w-full md:px-[100px]">
      ...
      <div className="bg-secondary text-primary px-[75px] md:px-[100px]">
        <div className="max-w-[400px] mx-auto py-[50px] md:max-w-full flex flex-col justify-center items-start gap-[30px] md:flex-row">
          ...
          <div className="w-full max-w-[400px] flex justify-start items-center md:max-w-[80%]">
      ...
      <div className="px-[75px] md:px-[100px] bg-primary" id="blog">
      ...
      <div className="px-[75px] md:px-[100px] min-h-[75vh] text-primary flex flex-col md:justify-center md:items-start relative">
      ...
      <div className="px-[75px] md:px-[100px] bg-primary" id="contact">
        <div className="max-w-[400px] mx-auto py-[50px] md:max-w-full">
          <h2 className="text-3xl text-center">Contact</h2>
          <Form />
        </div>
      </div>
      <footer className="px-[75px] md:px-[100px] bg-secondary text-primary text-base">
